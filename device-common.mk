...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/telephony/apns-conf.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/apns-conf.xml \
...
# First Stage Mount
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/fstab.universal5420:$(TARGET_COPY_OUT_RAMDISK)/fstab.universal5420 \
    $(COMMON_PATH)/rootdir/fstab.universal5420:$(TARGET_COPY_OUT_VENDOR)/fstab.universal5420
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy.conf \
    $(LOCAL_PATH)/configs/audio/silence.wav:$(TARGET_COPY_OUT_VENDOR)/etc/silence.wav \
